...
{
    loginForInsert($_POST['username'], $_POST['password']);
}
else if ($_SERVER['REQUEST_METHOD'] == "GET")
{
    if (isset($_GET['insert_login_error']))
    {
      $login_errors_insert = $_GET['insert_login_error'];
    }
} */
...
if(isset($_POST['loginsubmit']))
{
    ...
    if (($username == "$my_username") && (password_verify($password, $my_password)))
    {
        ...
        $login_errors_insert = "Invalid Login";
    }
}
